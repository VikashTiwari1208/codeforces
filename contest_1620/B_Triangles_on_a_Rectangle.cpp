...
int32_t main()
{
    fast;
       test 
       {
         ...
         cin>>a;
         input(v2,a);
         int op1=abs(h1[0]-h1[h1.size()-1])*y;
         int op2=abs(h2[0]-h2[h2.size()-1])*y;
         int op3=abs(v1[0]-v1[v1.size()-1])*x;
        int op4=abs(v2[0]-v2[v2.size()-1])*x;
        cout<<max({op1,op2,op3,op4})<<endl;
       } 
    return 0;
}