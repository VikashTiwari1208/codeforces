...
void merge(int a,int b)
{
   ...
   // cout<<a+1<<" "<<b+1<<endl;
    if(para!=parb)
    {
        ...
        {
           if(plant[para]==0&&plant[parb]==1)
           {
             sum+=ranks[para];
             plant[para]=1;
             //cout<<sum<<" parent of a is added of size "<<ranks[para]<<endl;
           }
           if(plant[para]==1&&plant[parb]==0)
           {
            sum+=ranks[parb];
            plant[parb]=1;
            //cout<<sum<<" parent of b is added of size "<<ranks[parb]<<endl;
           }
            parent[para]=parb;
