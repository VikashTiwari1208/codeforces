...
struct custom_hash {
    static uint64_t spliidxix64(uint64_t x) {
    ...
    size_t operator()(uint64_t x) const {
        ...
        return spliidxix64(x + FIXED_RANDOM);
    }
};
...
//upper_bound return first element in the range which has temp1ue greater than given temp1ue 
// ye dekhlena
int32_t main()
{
    fast;
