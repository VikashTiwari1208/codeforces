...
// ye dekhlena
bool isvalid(int idx1,int idx2,int idx3,vector<int>&v)
{
    if(v[idx2]<=v[idx3]&&v[idx1]<=v[idx2]||v[idx2]>=v[idx3]&&v[idx1]>=v[idx2])
    {
        return false;
    }
    return true;
    ...
    fast;
       test 
       {
          ...
          for(int i=0;i<=n-4;i++)
          {
              ...
              idx2=i+1;//z1 z2 z3
              idx3=i+2;
              //cout<<v[idx1]<<" "<<v[idx2]<<" "<<v[idx3]<<endl;
              bool flag1=isvalid(idx1,idx2,idx3,v);
            //  cout<<flag1<<endl;
              idx1=i+1;
              idx2=i+2; //z2 z3 z4
              idx3=i+3;
             //  cout<<v[idx1]<<" "<<v[idx2]<<" "<<v[idx3]<<endl;
              bool flag2=isvalid(idx1,idx2,idx3,v);
              //cout<<flag2<<endl;
              idx1=i;
              idx2=i+2;
              idx3=i+3;  //z1 z3 z4
              // cout<<v[idx1]<<" "<<v[idx2]<<" "<<v[idx3]<<endl;
              bool flag3=isvalid(idx1,idx2,idx3,v);
            //  cout<<flag3<<endl;
              idx1=i;
              idx2=i+1; //z1 z2 z4
              idx3=i+3;
               //cout<<v[idx1]<<" "<<v[idx2]<<" "<<v[idx3]<<endl;
              bool flag4=isvalid(idx1,idx2,idx3,v);
              //cout<<flag<<endl;
